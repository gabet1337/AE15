...
set output 'plot/L2_TCM.png'
set title "L2 Total Cache Miss"
set xlabel "N"
set ylabel "Misses"
set key left top

plot "naive_l2_l3_tcm_l2_tcm.dat" title 'naive', \
     "naive2_l2_l3_tcm_l2_tcm.dat" title 'naive2', \
     "naive2_l2_l3_tcm_l2_tcm.dat" title 'naive2-par2', \
     "naive2_l2_l3_tcm_l2_tcm.dat" title 'naive2-par4', \
     "a-trans_l2_l3_tcm_l2_tcm.dat" title 'A-trans', \
     "b-trans_l2_l3_tcm_l2_tcm.dat" linetype 7 title 'B-trans'

set output 'plot/L3_TCM.png'
set title "L3 Total Cache Miss"
set xlabel "N"
set ylabel "Misses"
set key left top

plot "naive_l2_l3_tcm_l3_tcm.dat" title 'naive', \
     "naive2_l2_l3_tcm_l3_tcm.dat" title 'naive2', \
     "naive2_l2_l3_tcm_l3_tcm.dat" title 'naive2-par2', \
     "naive2_l2_l3_tcm_l3_tcm.dat" title 'naive2-par4', \
     "a-trans_l2_l3_tcm_l3_tcm.dat" title 'A-trans', \
     "b-trans_l2_l3_tcm_l3_tcm.dat" linetype 7 title 'B-trans'
